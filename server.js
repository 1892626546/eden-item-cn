...
var b = browserify();
b.add("./public/common.js")
  .add("./public/client.js")
  .add("./public/item-tree.js")
  .add("./public/imports.js")
  .add("./public/custom-build.js");
...
app.get("/chars", function(request, response) {
  response.render("chars", {
    layout: "char-build",
    chars: Object.keys(builds),
    builds: builds,
    heroTypes: ["str", "agi", "int"]
  });
});
